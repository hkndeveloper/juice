        ...
        <AnimatePresence>
            {isLoading && (
                ...
                >
                    ...
                    `}</style>
                    <div className="relative flex flex-col items-center gap-12 max-w-xs w-full px-6">
                        {/* Hamster Loader */}
                        ...
                        <div className="w-full space-y-4">
                            <div className="relative h-1 w-full bg-white/5 rounded-full overflow-hidden">
                                <motion.div
                                    className="absolute top-0 left-0 h-full bg-tech-blue shadow-[0_0_15px_rgba(34,197,94,0.6)]"
                                    initial={{ width: 0 }}
                        ...
                        {/* Ambient Glow */}
                        <div className="absolute -z-10 w-64 h-64 bg-tech-blue/5 blur-[100px] rounded-full" />
                    </div>

                    {/* Footer decoration */}
                    <div className="absolute bottom-12 left-0 w-full flex flex-col items-center gap-4">
                        <div className="w-px h-12 bg-gradient-to-t from-tech-blue/20 to-transparent" />
